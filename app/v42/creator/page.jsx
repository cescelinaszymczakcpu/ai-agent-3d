...
const HAT_DEFAULTS={
 fedora:{color:"#8E72FF",collisionRadius:.035},
 "top-hat":{color:"#765BFF",collisionRadius:.035},
 bowler:{color:"#8A7CFF",collisionRadius:.035},
 beret:{color:"#B57CFF",collisionRadius:.040},
 "soft-cap":{color:"#6FE8FF",collisionRadius:.038},
 "wide-brim":{color:"#9A82FF",collisionRadius:.045},
};
...
export default function LivingOrbCreatorPage(){
 ...
 return <main className="creatorRoot" style={{background:"#020611"}}>
  ...
  <aside className="creatorPanel">
   ...
   <p className="creatorIntro">Living Orb pozostaje bazą. Opcjonalne warstwy mają osobne error boundaries, a każdy przycisk widoku może ponownie ustawić kamerę po ręcznym obrocie.</p>
   ...
   <div className="stageNote">NAPRAWA + COMPLETE CURRENT SET: powtarzalne view buttons · free OrbitControls · error boundaries · HEADSET · pełny zestaw okularów · flyaways/kitki · facial hair · head accessories · pełny zestaw kapeluszy. Orb, breathing, color flow i speech-driven gestures pozostają aktywne.</div>
  </aside>
 </main>;
}
