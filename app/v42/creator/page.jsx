...
export default function LivingOrbCreatorPage(){
 ...
 const selectHat=v=>{patchHat({type:v,color:v==="top-hat"?"#765BFF":"#8E72FF",offsetX:0,offsetY:0,offsetZ:0,rotationX:0,rotationY:0,rotationZ:0});if(v!=="none")patchBow({type:"none"});};
 ...
 return <main className="creatorRoot" style={{background:"#020611"}}>
  <section className="creatorPreview" style={{background:"#020611"}}>
   ...
   <div className="creatorBadge">SAFE BODY · BOWS + HATS · {state.toUpperCase()}</div>
  ...
  <aside className="creatorPanel">
   ...
   <div className="stageNote">HAT TEST: FEDORA / TOP HAT · FRONT / LEFT / RIGHT / BACK / TOP · NONE / SHORT / REFERENCE CURL / LONG HAIR clearance · test penetracji z maksymalnym promieniem orba podczas breathing. HAT i BOW są chwilowo wzajemnie wykluczone do czasu resolvera kolizji między dodatkami.</div>
  </aside>
 </main>;
}
