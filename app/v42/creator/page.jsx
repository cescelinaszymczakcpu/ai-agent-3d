...
export default function LivingOrbCreatorPage(){
 ...
 return <main className="creatorRoot" style={{background:"#020611"}}>
  <section className="creatorPreview" style={{background:"#020611"}}>
   {characterType==="orb"&&<LivingLumeniaOrb emotion={emotion} view={view} colorFlowSpeed={flow} orbColors={colors} state={state} audioLevel={realtime.audioLevel} audioBands={realtime.audioBands} hair={hair} facialHair={facialHair} bow={bow} hat={hat} audio={audioAccessory} glasses={glasses} style={{width:"100%",height:"100%",minHeight:"100%",background:"#020611"}}/>}
  ...
  <aside className="creatorPanel">
   ...
   <p className="creatorIntro">Living Orb pozostaje bazą. Opcjonalne warstwy mają osobne error boundaries, a kamera po wybraniu FRONT/LEFT/RIGHT/BACK/TOP pozwala na swobodny obrót.</p>
   ...
   <div className="stageNote">NAPRAWA + ETAP 8/9/10: free OrbitControls · error boundaries · CAT EYE · flyaway hair + kitki · REFERENCE CURLED / CLASSIC / SLIM / HANDLEBAR / SHORT / BEARD / GOATEE. Orb, breathing, color flow i speech-driven gestures pozostają aktywne.</div>
  </aside>
 </main>;
}
