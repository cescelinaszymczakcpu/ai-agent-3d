...
export default function LivingOrbCreatorPage(){
 ...
 const selectAudio=v=>{patchAudio({type:v,color:v==="headphones"?"#6FE8FF":"#7FEAFF",collisionRadius:v==="headphones"?.060:.055,offsetX:0,offsetY:0,offsetZ:0,rotationX:0,rotationY:0,rotationZ:0});if(v!=="none"){patchBow({type:"none"});patchHat({type:"none"});}};
 ...
 return <main className="creatorRoot" style={{background:"#020611"}}>
  <section className="creatorPreview" style={{background:"#020611"}}>
   ...
   <div className="creatorBadge">SAFE BODY · BOWS + HATS + AUDIO · {state.toUpperCase()}</div>
  ...
  <aside className="creatorPanel">
   ...
   <div className="stageNote">AUDIO TEST: EARMUFFS / HEADPHONES · FRONT / LEFT / RIGHT / BACK / TOP · NONE / SHORT / REFERENCE CURL / LONG HAIR · skrajne SCALE/OFFSET/ROTATION · brak penetracji orba podczas breathing. BOW / HAT / AUDIO są chwilowo wzajemnie wykluczone do czasu resolvera kolizji między różnymi dodatkami.</div>
  </aside>
 </main>;
}
