...
export default function LivingOrbCreatorPage(){
 ...
 return <main className="creatorRoot" style={{background:"#020611"}}>
  ...
  <aside className="creatorPanel">
   ...
   <div className="stageNote">NAPRAWA + REMAINING: powtarzalne view buttons · free OrbitControls · error boundaries · HEADSET · ROUND/OVAL/CAT EYE/RECTANGULAR/FUTURISTIC/MONOCLE · flyaways/kitki · facial hair · head accessories. Orb, breathing, color flow i speech-driven gestures pozostają aktywne.</div>
  </aside>
 </main>;
}
